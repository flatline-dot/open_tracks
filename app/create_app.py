    ...
    def __init__(self, parent, controller, comports_status):
        ...
        class ButtonFrame(Frame):
            def __init__(self, rely, text, command, container, state='disabled'):
                ...
                self.button = Button(self, text=text, width=22, height=2, borderwidth=2, font='Times 8 bold', relief='raised', command=command, state=state)
        ...
        vector_button = ButtonFrame(0.7, 'Вектор состояния', lambda: controller.show_frame(VectorPage), container_buttons)
