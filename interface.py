...
class Table():
    ...
    def __init__(self, window, col=0, row=0, port=None, name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=(0, 0), body_font=BODY_FONT, body_h=BODY_H ,head_font=HEAD_FONT):
        ...
        frame_l1of.grid(row=3 + row, column=0 + col, padx=pad_x)
        ...
        l1of_tu.grid(row=3 + row, column=1+col)
        ...
        l1of_fact.grid(row=3 + row, column=2 + col)
        ...
        self.gln_l1of_status_frame.grid(row=3 + row, column=3 + col)
        ...
        l1sf_title.grid(row=4 + row, column=0 + col, padx=pad_x)
        ...
        l1sf_tu.grid(row=4 + row, column=1 + col)
        ...
        l1sf_fact.grid(row=4 + row, column=2 + col)
        ...
        self.gln_l1sf_status_frame.grid(row=4 + row, column=3 + col)
        ...
        l2of_title.grid(row=5 + row, column=0 + col, padx=pad_x)
        ...
        l2of_tu.grid(row=5 + row, column=1 + col)
        ...
        l2of_fact.grid(row=5 + row, column=2 + col)
        ...
        self.gln_l2of_status_frame.grid(row=5 + row, column=3 + col)
        ...
        l2sf_title.grid(row=6 + row, column=0 + col, padx=pad_x)
        ...
        l2sf_tu.grid(row=6 + row, column=1 + col)
        ...
        l2sf_fact.grid(row=6 + row, column=2 + col)
        ...
        self.gln_l2sf_status_frame.grid(row=6 + row, column=3 + col)
        ...
        l1oc_mix.grid(row=7 + row, column=0 + col, sticky='w', padx=pad_x)
        ...
        l1oc_p_title.grid(row=7 + row, column=0 + col, sticky='en')
        ...
        l1oc_p_tu.grid(row=7 + row, column=1 + col, sticky='n')
        ...
        l1oc_p_fact.grid(row=7 + row, column=2 + col, sticky='n')
        ...
        self.gln_l1oc_p_status_frame.grid(row=7 + row, column=3 + col, sticky='n')
        ...
        l1oc_d_title.grid(row=7 + row, column=0 + col, sticky='es')
        ...
        l1oc_d_tu.grid(row=7 + row, column=1 + col, sticky='s')
        ...
        l1oc_d_fact.grid(row=7 + row, column=2 + col, sticky='s')
        ...
        self.gln_l1oc_d_status_frame.grid(row=7 + row, column=3 + col, sticky='s')
        ...
        l1sc_mix.grid(row=9 + row, column=0 + col, sticky='w', padx=pad_x)
        ...
        l1sc_p_title.grid(row=9 + row, column=0 + col, sticky='en')
        ...
        l1sc_p_tu.grid(row=9 + row, column=1 + col, sticky='n')
        ...
        l1sc_p_fact.grid(row=9 + row, column=2 + col, sticky='n')
        ...
        self.gln_l1sc_p_status_frame.grid(row=9 + row, column=3 + col, sticky='n')
        ...
        l1sc_d_title.grid(row=9 + row, column=0 + col, sticky='es')
        ...
        l1sc_d_tu.grid(row=9 + row, column=1 + col, sticky='s')
        ...
        l1sc_d_fact.grid(row=9 + row, column=2 + col, sticky='s')
        ...
        self.gln_l1sc_d_status_frame.grid(row=9 + row, column=3 + col, sticky='s')
        ...
        l2oc_mix.grid(row=11 + row, column=0 + col, sticky='w', padx=pad_x)
        ...
        l2oc_p_title.grid(row=11 + row, column=0 + col, sticky='en')
        ...
        l2oc_p_tu.grid(row=11 + row, column=1 + col, sticky='n')
        ...
        l2oc_p_fact.grid(row=11 + row, column=2 + col, sticky='n')
        ...
        self.gln_l2oc_p_status_frame.grid(row=11 + row, column=3 + col, sticky='n')
        ...
        l2oc_ksi_title.grid(row=11 + row, column=0 + col, sticky='es')
        ...
        l2oc_ksi_tu.grid(row=11 + row, column=1 + col, sticky='s')
        ...
        l2oc_ksi_fact.grid(row=11 + row, column=2 + col, sticky='s')
        ...
        self.gln_l2oc_ksi_status_frame.grid(row=11 + row, column=3 + col, sticky='s')
        ...
        l2sc_mix.grid(row=13 + row, column=0 + col, sticky='w', padx=pad_x)
        ...
        l2sc_p_title.grid(row=13 + row, column=0 + col, sticky='en')
        ...
        l2sc_p_tu.grid(row=13 + row, column=1 + col, sticky='n')
        ...
        l2sc_p_fact.grid(row=13 + row, column=2 + col, sticky='n')
        ...
        self.gln_l2sc_p_status_frame.grid(row=13 + row, column=3 + col, sticky='n')
        ...
        l2sc_d_title.grid(row=13 + row, column=0 + col, sticky='es')
        ...
        l2sc_d_tu.grid(row=13 + row, column=1 + col, sticky='s')
        ...
        l2sc_d_fact.grid(row=13 + row, column=2 + col, sticky='s')
        ...
        self.gln_l2sc_d_status_frame.grid(row=13 + row, column=3 + col, sticky='s')
        ...
        gps_l1_title.grid(row=14 + row, column=0 + col, padx=pad_x)
        ...
        gps_l1_tu.grid(row=14 + row, column=1 + col)
        ...
        gps_l1_fact.grid(row=14 + row, column=2 + col)
        ...
        self.gps_l1_status_frame.grid(row=14 + row, column=3 + col)
        ...
        gps_l2_l_title.grid(row=15 + row, column=0 + col, sticky='en')
        ...
        gps_l2_l_tu = Frame(window, relief='raised', borderwidth=1, width=tu_w, height=body_h, background='#f5fcff')
        gps_l2_l_tu.grid(row=15 + row, column=1 + col, sticky='n')
        gps_l2_l_tu.grid_propagate(False)
        self.gps_l2_l_tu = Label(gps_l2_l_tu, text='8', font=body_font, background='#f5fcff')
        self.gps_l2_l_tu.place(relx=0.5, rely=0.5, anchor='center')

        gps_l2_l_fact = Frame(window, relief='raised', borderwidth=1, width=fact_w, height=body_h, background='#f5fcff')
        gps_l2_l_fact.grid(row=15 + row, column=2 + col, sticky='n')
        gps_l2_l_fact.grid_propagate(False)
        self.gps_l2_l_fact = Label(gps_l2_l_fact, text='0', font=body_font, background='#f5fcff')
        self.gps_l2_l_fact.place(relx=0.5, rely=0.5, anchor='center')

        self.gps_l2_l_status_frame = Frame(window, relief='raised', borderwidth=1, width=status_w, height=body_h, background='#f5fcff')
        self.gps_l2_l_status_frame.grid(row=15 + row, column=3 + col, sticky='n')
        ...
        sdkm_title.grid(row=16 + row, column=0 + col, padx=pad_x)
        ...
        sdkm_tu.grid(row=16 + row, column=1 + col)
        ...
        sdkm_fact.grid(row=16 + row, column=2 + col)
        ...
        self.sdkm_status_frame.grid(row=16 + row, column=3 + col)
        ...
        sdps_title.grid(row=17 + row, column=0 + col, padx=pad_x)
        ...
        sdps_tu.grid(row=17 + row, column=1 + col)
        ...
        sdps_fact.grid(row=17 + row, column=2 + col)
        ...
        self.sdps_status_frame.grid(row=17 + row, column=3 + col)
        ...
        self.vector_frame.grid(row=2 + row, column=col, columnspan=4, padx=pad_x)
