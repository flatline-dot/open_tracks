...
class Table():
    ...
    def __init__(self, window, col=0, row=0, port=None, name_w=0, tu_w=0, fact_w=0, status_w=0, head_h=0, pad_x=(0, 0), body_font='Times 8', body_h=BODY_H):
        ...
        self.gps_l2_mix_label = Label(gps_l2_mix, text='GPS L2', font=body_font)
        ...
        sdps.grid(row=16 + row, column=0 + col, padx=pad_x)
...
a = Table(window, col=0, row=0, port=str(1), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H)
Table(window, col=4, row=0, port=str(2), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=8, row=0, port=str(3), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=12, row=0, port=str(4), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=16, row=0, port=str(5), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=20, row=0, port=str(6), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=24, row=0, port=str(7), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=28, row=0, port=str(8), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)


Table(window, col=0, row=19, port=str(9), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H)
Table(window, col=4, row=19, port=str(10), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=8, row=19, port=str(11), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=12, row=19, port=str(12), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=16, row=19, port=str(13), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=20, row=19, port=str(14), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
Table(window, col=24, row=19, port=str(15), name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=PAD_X)
