...
class Table():
    ...
    def __init__(self, window, col=0, row=0, port=None, name_w=NAME_W, tu_w=TU_W, fact_w=FACT_W, status_w=STATUS_W, head_h=HEAD_H, pad_x=(0, 0), body_font='Times 8', body_h=BODY_H):
        ...
        self.gln_l1sf_status = Label(l1sf_status, text='', font=body_font)
        ...
        self.gln_l2of_status = Label(l2of_status, text='', font=body_font)
        ...
        self.gln_l2sf_status = Label(l2sf_status, text='', font=body_font)
        ...
        self.gln_l1oc_p_status = Label(l1oc_p_status, text='', font=body_font)
        ...
        self.gln_l1oc_d_status = Label(l1oc_d_status, text='', font=body_font)
        ...
        self.gln_l1sc_p_status = Label(l1sc_p_status, text='', font=body_font)
        ...
        self.gln_l1sc_d_status = Label(l1sc_d_status, text='', font=body_font)
        ...
        self.gln_l2oc_p_status = Label(l2oc_p_status, text='', font=body_font)
        ...
        self.gln_l2oc_ksi_status = Label(l2oc_ksi_status, text='', font=body_font)
        ...
        self.gln_l2sc_p_status = Label(l2sc_p_status, text='', font=body_font)
        ...
        self.gln_l2sc_d_status = Label(l2sc_d_status, text='', font=body_font)
        ...
        self.gps_l1_status = Label(gps_l1_status, text='', font=body_font)
        ...
        self.gps_l2_l_status = Label(gps_l2_l_status, text='', font=body_font)
        ...
        self.gps_l2_m_status = Label(gps_l2_m_status, text='', font=body_font)
        ...
        self.sdkm_status = Label(sdkm_status, text='', font=body_font)
        ...
        self.sdps_status = Label(sdps_status, text='', font=body_font)
...
a = Table(window, col=0, row=0, port=str(1))
